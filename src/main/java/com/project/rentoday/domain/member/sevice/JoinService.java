...
public class JoinService {
    ...
    //이메일 중복검사 / 이메일 전송
    public void emailCheck(EmailDto.Request emailRequest) throws MessagingException {
    ...
    //회원가입 처리를 위한 메서드
    @Transactional
    public void joinProcess(MemberDto.CreateRequest createRequest) throws IOException {
